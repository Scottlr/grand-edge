...
const STRATEGY_ID: &str = "online_ensemble_v1";
const STRATEGY_VERSION: &str = "v1";

#[derive(Debug, Clone, Default)]
pub struct OnlineEnsembleStrategy {
    pub artifact: Option<ModelArtifactMetadata>,
}

impl Strategy for OnlineEnsembleStrategy {
    ...
    fn generate(
        ...
        Err(StrategyError::Validation(
            "online ensemble adapter requires validated artifact runtime support".to_string(),
        ))
    }
}
