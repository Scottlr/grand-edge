...
const STRATEGY_ID: &str = "meta_label_v1";
const STRATEGY_VERSION: &str = "v1";

#[derive(Debug, Clone, Default)]
pub struct MetaLabelStrategy {
    pub artifact: Option<ModelArtifactMetadata>,
}

impl Strategy for MetaLabelStrategy {
    ...
    fn generate(
        ...
        Err(StrategyError::Validation(
            "meta-label adapter requires validated artifact runtime support".to_string(),
        ))
    }
}
